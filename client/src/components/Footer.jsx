			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
					...
					<div className="space-y-6">
						<img src={logo} alt="EZY Skills Logo" className="h-16 w-auto" />
						...
						<div className="mt-8">
							...
							<div className="flex">
								...
								/>
								<button
									className="px-6 py-3 bg-orange-500 hover:bg-orange-600 transition-colors rounded-r-lg"
						...
						<div className="space-y-4">
							...
							<div className="flex items-start gap-3">
								...
								<div className="text-sm text-gray-300">
									<a
										href="tel:+918428448903"
										className="block hover:text-orange-500 transition-colors">
										+91 8428448903
									</a>
									<a
										href="tel:+919475484959"
										className="block hover:text-orange-500 transition-colors">
										+91 9475484959
									</a>
								</div>
				...
				{/* Bottom Section - Social Media & Legal Links */}
				<div className="mt-12 pt-8 border-t border-blue-800">
					<div className="flex flex-col md:flex-row justify-between items-center gap-6">
						...
						<div className="flex gap-4">
							<a
								...
								className="w-10 h-10 bg-blue-800 hover:bg-orange-500 rounded-full flex items-center justify-center transition-colors"
								aria-label="Facebook">
								<svg
									className="w-5 h-5"
									fill="currentColor"
					...
					<div className="text-center mt-8 text-sm text-gray-400">
						<p>
							&copy; {new Date().getFullYear()} EZY Skills. All rights reserved.
						</p>
					</div>
				</div>
			</div>
